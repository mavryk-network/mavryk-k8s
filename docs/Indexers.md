...
The [Mavryk Helm chart's values.yaml](https://github.com/mavryk-network/mavryk-k8s/blob/master/charts/tezos/values.yaml) has an `indexer` section for how to deploy an indexer.
